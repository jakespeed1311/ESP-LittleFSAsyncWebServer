...
const char* ssid = "Hundundsau";
const char* password = "norbertswlan";
...
void setup(){
 ...
 // SPIFFS.begin();
  ...
  server.serveStatic("/index.htm", LittleFS, "/index.htm").setDefaultFile("index.htm");
 ...
 ftpSrv.begin("esp8266","esp8266");    //username, password for ftp.  set ports in ESP8266FtpServer.h  (default 21, 50009 for PASV)
   ...
   Serial.println("Dir Inhalt Start");
...
File fx = LittleFS.open("/index.htm", "r");
if (!fx) {
 ...
 File file = LittleFS.open("/Create.txt", "w");
...
while (dir.next()) {
  ...
  File f = LittleFS.open("/Create.txt", "r");
